...
export class ChallengesController extends BaseController {
  constructor() {
    ...
    this.router
      ...
      .get('/:id/difficulties', this.getDifficultyRatingsByChallengeId)
      .get('/:id/reviews', this.getReviewRatingsByChallengeId)
      ...
      .post('/:id/reviews', this.handleReviewRating)
      .post('/:id/difficulties', this.handleDifficultyRating)
