<template>
  <div class="row mx-1 mt-4">
    <div class=" col card pt-2">
      <img class="card-img-top banner" :src="state.challenge.banner" @error="state.challenge.banner='https://source.unsplash.com/8l8Yl2ruUsg/1600x800'" alt="Profile Banner">

      <div class="row justify-content-center rel">
        <img class="rounded-circle ab circle-img profColor" :src="state.challenge.image" @error="state.challenge.image='https://source.unsplash.com/vWyLVrlOdus/800x800'" alt="Profile Image">
      </div>
