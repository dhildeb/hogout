<template>
  ...
  <div class="col-12">
    ...
    >
      <div class="col-12">
        <img class="card-img-top challenge-banner" :src="state.challenge.banner" @error="state.challenge.banner='https://source.unsplash.com/8l8Yl2ruUsg/1600x800'" alt="Profile Banner">
      </div>

      <div class="col-12 d-flex justify-content-center text-center pt-4">
        <div class="col-4 justify-content-center pl-5 ">
          <img class="rounded-circle db profColor" :src="state.challenge.image" @error="state.challenge.image='https://source.unsplash.com/vWyLVrlOdus/800x800'" alt="Profile Image">
